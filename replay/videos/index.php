          ...
          class="table table-bordered table-striped">
            ...
            <tbody>       
              ...
              <tr class="table table-bordered">
                  ...
                  <td>
                    <strong><a title="Voir la vidéo sur Replay" target="_blank" href="https://www.replay.gp/v/<?php echo($col['short_id']); ?>">
                        <?php echo($col['title']); ?>
                    </a></strong>
                    <BR><strong>Video_id:</strong>
                    <a target="_blank" href="https://www.replay.gp/edit-video/<?php echo($col['video_id']); ?>">
                      <?php echo($col['video_id']); ?>
                    </a>
                      /

                    <strong>Short_id:</strong>
                    <a title="Editer sur le site" target="_blank" href="https://www.replay.gp/v/<?php echo($col['short_id']); ?>">
                        <?php echo($col['short_id']); ?>
                    </a>
                      /

                      <?php if($col['daily']){?>
                        <strong>Dailymotion:</strong>
                        <a title="Regarder sur Dailymotion" target="_blank" href="https://www.dailymotion.com/video/<?php echo($col['daily']); ?>">
                          <?php echo($col['daily']); ?> 
                        </a>
                      <?php } ?>
                      ...
                      <?php if($col['youtube']){?>
                        ...
                        <a title="Regarder sur Youtube" target="_blank" href="https://www.youtube.com/watch?v=<?php echo($col['youtube']); ?>">
                          <?php echo($col['youtube']); ?> 
                        </a>
                      <?php } ?>
                  </td>  
                  <td>
                    <?php echo($col['time_date']); ?>
                  </td>
                  <td>
