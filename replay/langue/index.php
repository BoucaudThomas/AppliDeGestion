          ...
          class="table table-bordered table-striped">
            ...
            <tbody>       
              ...
              <tr class="table table-bordered">
                  ...
                  <td>
                    <a href="index.php?nav=2&q=<?php echo($col['lang_key']); ?>&action=rechercher">
                      <?php echo($col['lang_key']); ?>
                    </a>
                  </td>

                  <td>
                    <a href="index.php?nav=2&q=<?php echo($col['type']); ?>&action=rechercher">
                      <?php echo($col['type']); ?>
                    </a>
                  </td>
