...
<?php
	...
	if (isset($_POST["action"]) == "formimport") {
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="card card-success">
                                                ...
                                                <div class="card-body" style="display: block;">
                                                    <div class="form-group">
                                                        <textarea type="text" class="form-control" name="message" style="height: 150px" readonly>lang_key|type|francais|anglais|arabe|danois|allemande|russe|espagnol|turk<?php $resultat = $db->query("SELECT * FROM $db_table ORDER BY id DESC LIMIT 10");
                                                            while($col=$resultat->fetch()){?>
                                                            <?php echo($col['lang_key']); ?>|<?php echo($col['type']); ?>|<?php echo($col['french']); ?>|<?php echo($col['english']); ?>|<?php echo($col['arabic']); ?>|<?php echo($col['dutch']); ?>|<?php echo($col['german']); ?>|<?php echo($col['russian']); ?>|<?php echo($col['spanish']); ?>|<?php echo($col['turkish']); ?>
                                                            <?php }?>
                                                        </textarea>
                                                    </div>
                                                </div>
