	...
	if (isset($_POST["action"]) == "send") {
		...
		if ($_FILES["file"]["size"] > 0) {
			...
			while (($column = fgetcsv($file, 10000, "|")) !== FALSE) {
				...
				username='$column[0]',
				youtube='$column[1]',
                dailymotion='$column[2]',
                facebook='$column[3]',
                twitter='$column[4]',
                website='$column[5]',
                category_id='$column[6]',
                sub_category_id='$column[7]',
                avatar='$column[8]'
				");
			}
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="card card-success">
                                                ...
                                                <div class="card-body" style="display: block;">
                                                    <div class="form-group">
                                                        <textarea type="text" class="form-control" name="message" style="height: 150px" readonly>username|youtube|dailymotion|facebook|twitter|website|category_id|sub_category_id|avatarr<?php $resultat = $db->query("SELECT * FROM $db_table ORDER BY id DESC LIMIT 10");
